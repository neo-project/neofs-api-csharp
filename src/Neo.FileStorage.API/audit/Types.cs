...
namespace Neo.FileStorage.API.Audit {
    ...
    static TypesReflection() {
      ...
      descriptor = pbr::FileDescriptor.FromGeneratedCode(descriptorData,
          ...
          new pbr::GeneratedClrTypeInfo(null, null, new pbr::GeneratedClrTypeInfo[] {
            new pbr::GeneratedClrTypeInfo(typeof(global::Neo.FileStorage.API.Audit.DataAuditResult), global::Neo.FileStorage.API.Audit.DataAuditResult.Parser, new[]{ "Version", "AuditEpoch", "ContainerId", "PublicKey", "Complete", "Requests", "Retries", "PassSg", "FailSg", "Hit", "Miss", "Fail", "PassNodes", "FailNodes" }, null, null, null, null)
          }));
    }
    #endregion
  ...
  #endif
  {
    ...
    public static pbr::MessageDescriptor Descriptor {
      get { return global::Neo.FileStorage.API.Audit.TypesReflection.Descriptor.MessageTypes[0]; }
    }
    ...
    private static readonly pb::FieldCodec<global::Neo.FileStorage.API.Refs.ObjectID> _repeated_passSg_codec
        = pb::FieldCodec.ForMessage(66, global::Neo.FileStorage.API.Refs.ObjectID.Parser);
    private readonly pbc::RepeatedField<global::Neo.FileStorage.API.Refs.ObjectID> passSg_ = new pbc::RepeatedField<global::Neo.FileStorage.API.Refs.ObjectID>();
    /// <summary>
    /// List of Storage Groups that passed audit PoR stage
    /// </summary>
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public pbc::RepeatedField<global::Neo.FileStorage.API.Refs.ObjectID> PassSg {
      get { return passSg_; }
    }

    /// <summary>Field number for the "fail_sg" field.</summary>
    public const int FailSgFieldNumber = 9;
    private static readonly pb::FieldCodec<global::Neo.FileStorage.API.Refs.ObjectID> _repeated_failSg_codec
        = pb::FieldCodec.ForMessage(74, global::Neo.FileStorage.API.Refs.ObjectID.Parser);
    private readonly pbc::RepeatedField<global::Neo.FileStorage.API.Refs.ObjectID> failSg_ = new pbc::RepeatedField<global::Neo.FileStorage.API.Refs.ObjectID>();
    /// <summary>
    /// List of Storage Groups that failed audit PoR stage
    /// </summary>
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public pbc::RepeatedField<global::Neo.FileStorage.API.Refs.ObjectID> FailSg {
      get { return failSg_; }
    }
    ...
    void pb::IBufferMessage.InternalMergeFrom(ref pb::ParseContext input) {
      ...
      while ((tag = input.ReadTag()) != 0) {
        switch(tag) {
          ...
          case 66: {
            passSg_.AddEntriesFrom(ref input, _repeated_passSg_codec);
            break;
          }
          case 74: {
            failSg_.AddEntriesFrom(ref input, _repeated_failSg_codec);
            break;
          }
          case 80: {
            Hit = input.ReadUInt32();
          ...
          case 106: {
            passNodes_.AddEntriesFrom(ref input, _repeated_passNodes_codec);
            break;
          }
          case 114: {
            failNodes_.AddEntriesFrom(ref input, _repeated_failNodes_codec);
            break;
          }
        }
      }
